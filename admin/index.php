              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Sunshine Express</h1>
                  </div>
                  <form action="controllers/user_controller.php" method="POST">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="email"  aria-describedby="emailHelp" placeholder="Enter Username or Email Address..." required>
                    </div>
                    <div class="form-group">
