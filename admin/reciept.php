              ...
              <div class = "row">
                ...
                <div class="col-md-6">
                  <div class="row">
                    ...
                    <div class = "col-md-6">
                      <img  width = "150" height = "150" src="img/bus.png" alt="Sunshine Express Logo"/>
                    </div>
                  </div>
                </div>
              </div>
...
else if (isset($_GET['bkr'])){
  $booking_id = $_GET['bkr'];
  // Since the html part of this page is repeated I could just copy it into a page and include it when necessary
  $bookingInfo = new Booking();
  $b_details = $bookingInfo->getBookingDetails($booking_id);
  foreach($b_details as $theDetails){
    $pname = $b_details['pname'];
